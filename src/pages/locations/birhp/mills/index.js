    ...
    return (
        ...
        <div className='max-w-7xl mx-auto pb-20'>
            <div className='w-4/5 rounded-xl bg-white mx-auto pb-16'>
                <h1 className="p-4 pt-12 text-4xl font-['Merriweather'] font-extrabold text-center">Mills peak adventures</h1>
                <div className='flex justify-center items-center flex-col gap-y-14'>
                    <div className="grid grid-cols-2 w-1/2 text-black pt-20 gap-y-10 heading-font">
                        <div>Address</div>
                        <div class="mb-2 underline">Adv Landing Site, Satish Kumar Mills Peak, Road, Bir Colony, Suja, Himachal Pradesh 176077</div>
                        <div>Phone</div>
                        <div>082195 24810</div>
                    </div>
