        ...
        <Layout navbar={'white'}>
            ...
            <div className='max-w-7xl mx-auto pb-20'>
                <div className='w-4/5 rounded-xl bg-white mx-auto pb-16'>
                    <h1 className="p-4 pt-12 text-4xl font-['Merriweather'] font-extrabold text-center">Paragliding Landing Zone</h1>
                    <div className='flex justify-center items-center flex-col gap-y-14'>
                        <div className="grid grid-cols-2 w-1/2 text-black pt-20 gap-y-10 heading-font">
                            <div>Address</div>
                            <div class="mb-2 underline">Chaugan - Sansal Rd, Bir Colony, Suja, Himachal Pradesh 176077</div>
                            <div>Phone</div>
                            <div>085447 94593</div>
                        </div>
